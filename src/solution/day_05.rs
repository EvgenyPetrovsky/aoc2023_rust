        ...
        mappings
            ...
            .filter_map(|m| {
                ...
                // right part {seed_rng} inside [mapping]: __{__[**}__]__
                    ...
                    Some(Rng { start: dest, len: s_end - m_beg }) }
                ...
                // {seed_rng} fully includes [mapping]:    __{__[**]__}__
                    ...
                    Some(Rng { start: dest, len: m_end - m_beg }) }
                // :-O unknown case
...
mod tests {
    ...
    fn parse_mapping_lines() {
        ...
        assert_eq!(
            ...
            vec![
                Mapping{ dest_start:   0, src_rng: Rng{ start:   0, len: 50 }},
                Mapping{ dest_start:  52, src_rng: Rng{ start:  50, len: 48 }},
                Mapping{ dest_start:  50, src_rng: Rng{ start:  98, len:  2 }},
                Mapping{ dest_start: 100, src_rng: Rng{ start: 100, len: u64::MAX - 100 }},
            ]
        )
    }
    #[test]
    fn map_once() {
        ...
        assert_eq!(
            ...
            vec![
                Rng{ start: 52 + (95 - 50), len: 3 }, //  95 ..  98
                Rng{ start: 50 + (98 - 98), len: 2 }, //  98 .. 100
                Rng{ start:100 + (100-100), len: 5 }, // 100 .. 105
            ]
        )
    }
